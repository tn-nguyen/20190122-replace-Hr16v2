define({
  ...
  "The VCA Camera configuration is changed by %s." : "La configuration de VA de la caméra est changée par %s.",
  "The VCA event configuration is changed by %s." : "La configuration d'événement VA est cgangée par %s.",
