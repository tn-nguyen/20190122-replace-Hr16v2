define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "Kamerada bir VA olayı #%02d: %s.",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "VA kullanmak için kameralar yeniden bağlanacak.\nDevam etmek istiyor musunuz?",
  "Please select the channel of using vca." : "VA kullanmak için lütfen kanalı seçin.",
  ...
  "PING TEST" : "PING TEST",
  "Current channel does not support vca." : "Mevcut kanal va'yı desteklemiyor.",
  ...
  "The VCA Camera configuration is changed by %s." : "VA Kamera konfigürasyonu %s tarafından değiştirildi.",
  "The VCA event configuration is changed by %s." : "VA olay konfigürasyonu %s tarafından değiştirildi.",
  ...
  "30 MINUTES" : "30 DAKİKA",
  "60 MINUTES" : "60 DAKİKA",
  ...
  "CH ALL" : "CH ALL",
  "Language settings can only be changed via the local UI. Please set the language in the Session Setup window in the remote WebRA." : "퓨",
