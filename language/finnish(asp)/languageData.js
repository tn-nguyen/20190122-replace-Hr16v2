define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "VA-tapahtuma kamerassa #%02d: %s.",
  ...
  "VCA Counter" : "VA-laskuri",
  "VCA Fall" : "Kaatuu",
  "VCA Camera tamper" : "Kam. Sabotaasi",
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "Kameroihin yhdistetään uudelleen VA:n käyttämiseksi.\nHaluatko jatkaa?",
  "Please select the channel of using vca." : "Valitse käytettävä kanava VA-toimintoa varten.",
  ...
  "Current channel does not support vca." : "Nykyinen kanava ei tue VA-toimintoja.",
  ...
  "The VCA Camera configuration is changed by %s." : "%s muutti kameran VA-asetuksia.",
  "The VCA event configuration is changed by %s." : "%s muutti VA-tapahtuma-asetuksia.",
