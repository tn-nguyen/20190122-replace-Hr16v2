define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "Событие VA камеры  #%02d: %s.",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "Камеры будут переподключены для использования va. \n Вы хотите продолжить?",
  "Please select the channel of using vca." : "Пожалуйста, выберите канал использования va.",
  ...
  "PING TEST" : "PING Тест",
  "Current channel does not support vca." : "Данный канал не поддерживает va.",
  ...
  "The VCA Camera configuration is changed by %s." : "Конфигурация камеры  VA была изменена %s.",
  "The VCA event configuration is changed by %s." : "Конфигурация события VAбыла изменена %s.",
