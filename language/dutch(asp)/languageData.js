define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "Een VA gebeurtenis op camera #%02d: %s.",
  "You can use higher resolution of the camera if VA is off." : "U kan een hoegere resolutie gebruiken van de camera als VA uit staat.",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "De camera's worden herverbonden om VA te gebruiken.\nWilt u doorgaan?",
  "Please select the channel of using vca." : "Selecteer het kanaal dat VA gebruikt.",
  ...
  "PING TEST" : "PING TEST",
  "Current channel does not support vca." : "Huidig kanaal ondersteund geen VA",
  ...
  "The VCA Camera configuration is changed by %s." : "De VA Camera configuratie is gewijzigd door %s.",
  "The VCA event configuration is changed by %s." : "De VA gebeurtenissen configuratie is gewijzigd door %s.",
