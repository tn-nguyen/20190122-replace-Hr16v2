define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "VA hendelse på kamera #%02d: %s..",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "Kameraene vil koble til på nytt for å bruke va.\nVil du fortsette?",
  "Please select the channel of using vca." : "Velg kanal for va.",
  ...
  "PING TEST" : "PING TEST",
  "Current channel does not support vca." : "Valgte kanal støtter ikke va.",
  ...
  "The VCA Camera configuration is changed by %s." : "VA kamerakonfigurasjon er endret av %s.",
  "The VCA event configuration is changed by %s." : "VA hendelseskonfigurasjon er endret av %s.",
