define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "Ein VA event auf Kamera #%02d: %s.",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "Die Kameras werden wieder verbunden um va zu verwenden.\nFortfahren?",
  "Please select the channel of using vca." : "Bitte Kanal für va wählen.",
  ...
  "PING TEST" : "PING TEST",
  "Current channel does not support vca." : "Dieser Kanal unterstützt kein va.",
  ...
  "The VCA Camera configuration is changed by %s." : "VA Kamera Konfiguration wurde von  %s geändert.",
  "The VCA event configuration is changed by %s." : "VA Ereigniskonfiguration wurde von %s geändert.",
