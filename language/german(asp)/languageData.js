define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "Ein VA-Ereignis auf Kamera #%02d: %s.",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "Die Kameras werden neu verbunden, um VA zu benutzen.\nMöchten Sie fortfahren?",
  "Please select the channel of using vca." : "Bitte suche Sie den Kanal aus, der VA nutzen soll.",
  ...
  "PING TEST" : "PING-TEST",
  "Current channel does not support vca." : "Aktueller Kanal unterstützt kein va.",
  ...
  "The VCA Camera configuration is changed by %s." : "Die VA Kamera Konfiguration wurde von %s geändert.",
  "The VCA event configuration is changed by %s." : "Die VA Ereignis Konfiguration wurde von %s geändert.",
  ...
  "VCA SETUP WIZARD" : "VA EINSTELLUNGEN WIZARD",
