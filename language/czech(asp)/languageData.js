define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "VA událost na kameře #%02d: %s.",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "Před použitím VA budou kamery znovu připojeny.\nChcete pokračovat?",
  "Please select the channel of using vca." : "Vyberte prosím kanál pro použití VA.",
  ...
  "The VCA Camera configuration is changed by %s." : "Konfigurace VA kamery byla změněna uživatelem %s.",
  "The VCA event configuration is changed by %s." : "Konfigurace VA události byla změněna uživatelem %s.",
