define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "en VA hændelse på kamera #%02d: %s.",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "kameraet vil gen-forbinde til at bruge VA.\nvil du fortsætte?",
  "Please select the channel of using vca." : "vælg venligst hvilket kamaera til at bruge VA",
  ...
  "PING TEST" : "ping test",
  "Current channel does not support vca." : "aktuelle kamera understøtter ikke VA",
  ...
  "The VCA Camera configuration is changed by %s." : "VA kamera konfiguration er ændret af %s",
  "The VCA event configuration is changed by %s." : "VA hændelseskonfiguration er ændret af %s",
