define({
  ...
  "VCA" : "VA",
  "A VCA event on camera #%02d: %s." : "A VA event on camera #%02d: %s.",
  ...
  "The cameras will be reconnected to use vca.\nDo you want to continue?" : "The cameras will be reconnected to use va.\nDo you want to continue?",
  "Please select the channel of using vca." : "Please select the channel of using va.",
  ...
  "PING TEST" : "PING TEST",
  "Current channel does not support vca." : "Current channel does not support va.",
  "EDIT AREA" : "EDIT AREA",
  "MARK" : "MARK",
  "AUDIO IN" : "AUDIO IN",
  "AUDIO 1" : "AUDIO 1",
  ...
  "The VCA Camera configuration is changed by %s." : "The VA Camera configuration is changed by %s.",
  "The VCA event configuration is changed by %s." : "The VA event configuration is changed by %s.",
  ...
  "VCA SETUP WIZARD" : "VA SETUP WIZARD",
  ...
  "The occurrence of the AI detection event. [%s : %d%%]" : "The occurrence of the DLVA event. [%s : %d%%]",
  "PLAYBACK." : "PLAYBACK",
  "ADD/EDIT" : "ADD/EDIT",
  "IP CAMERA INSTALLATION" : "IP CAMERA INSTALLATION",
  "VIRTUAL CAMERA INSTALLATION" : "VIRTUAL CAMERA INSTALLATION",
  "CURRENT PASSWORD" : "CURRENT PASSWORD",
  "FISHEYE SETUP" : "FISHEYE SETUP",
  "FISHEYE CTRL" : "FISHEYE CTRL",
  "GROUND" : "GROUND",
  "SINGLE VIEW" : "SINGLE VIEW",
  "QUAD VIEW" : "QUAD VIEW",
  "PANORAMA VIEW" : "PANORAMA VIEW",
  "You must register the license to use this function.\nDo you want to go to the registration page and activate the license?" : "You must register the license to use this function.\nDo you want to go to the registration page and activate the license?",
  "You can not use the features such as the AI detection and the Fisheye Dewarping at the same time.\nThe AI detection will be automatically relieved in order to activate the feature of Fisheye Dewarping.\nDo you want to continue?" : "You can not use the features such as the DLVA and the Fisheye Dewarping at the same time.\nThe DLVA will be automatically relieved in order to activate the feature of Fisheye Dewarping.\nDo you want to continue?",
  "You can not use the features such as the AI detection and the Fisheye Dewarping at the same time.\nThe configured Fisheye Dewarping will be automatically relieved in order to activate the feature of the AI detection.\nDo you want to continue?" : "You can not use the features such as the DLVA and the Fisheye Dewarping at the same time.\nThe configured Fisheye Dewarping will be automatically relieved in order to activate the feature of the DLVA.\nDo you want to continue?",
  "CONTROL METHOD" : "TYPE",
  "1 STEP" : "ABSOLUTE",
  "SET" : "SET",
  ...
  "SETUP." : "SETUP",
  "RESOLUTION." : "RESOLUTION",
  "you can not change the settings locally while you are changing this setting in WebRA." : "you can not change the settings locally while you are changing this setting in WebRA.",
  ...
  "The AI detection function supports up to %d cameras only.\nCurrently activated channel : %s" : "The DLVA function supports up to %d cameras only.\nCurrently activated channel : %s",
  "The system log has been saved successfully." : "The system log has been saved successfully.",
  "It's failed to save the system log." : "It's failed to save the system log.",
  ...
  "While entering to this page, other users will not be able to use the device." : "While entering to this page, other users will not be able to use the device.",
  "Buffer Size" : "Buffer Size",
  "Caching" : "Caching",
  "Msec" : "Msec",
  "This firmware is QC test only. Please upgrade as released firmware." : "This firmware is QC test only. Please upgrade as released firmware.",
  ...
  "A user ID must contain at least 5 characters including alphanumeric characters." : "A user ID must contain at least 5 characters including alphanumeric characters.",
  "AI DETECTION FILTER" : "DLVA FILTER",
  ...
  "Network information and user information will also change to factory default value. \n Do you really want hard factory reset?" : "Network information and user information will also change to factory default value. \n Do you really want hard factory reset?",
  "Incorrect user id or password. The device will be locked after %d failed login attempts." : "Incorrect user id or password. The device will be locked after %d failed login attempts.",
  ...
  "HLC Control" : "HLC Control",
  "The higher number has higher property than other ROIs." : "The higher number has higher property than other ROIs.",
  "HTTP AUTHENTICATION" : "HTTP AUTHENTICATION",
  "Network port error occurred." : "Network port error occurred.",
  "SPOT1 - 9DIV" : "SPOT1 - 9DIV",
  "SPOT2 - 16DIV" : "SPOT2 - 16DIV",
  "Dynamic GOP" : "Dynamic GOP",
  "Image Quality" : "Image Quality",
  "IRIS auto mode" : "IRIS auto mode",
  "BUS AND FULL-SIZE CAR" : "BUS AND FULL-SIZE CAR",
  "" : ""
});